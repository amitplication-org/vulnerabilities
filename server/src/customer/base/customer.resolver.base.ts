...
export class CustomerResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => Score, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "Score",
    action: "read",
    possession: "any",
  })
  async score(@graphql.Parent() parent: Customer): Promise<Score | null> {
    const result = await this.service.getScore(parent.id);
